...
import reducer, {
  ...
  reset,
  updateEntity,
} from './recipe-to-ingredient.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECIPETOINGREDIENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RECIPETOINGREDIENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RECIPETOINGREDIENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RECIPETOINGREDIENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RECIPETOINGREDIENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RECIPETOINGREDIENT actions', async () => {
      const arg = 42666;
