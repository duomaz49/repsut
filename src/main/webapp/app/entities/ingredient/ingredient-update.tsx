  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="repsutApp.ingredient.home.createOrEditLabel" data-cy="IngredientCreateUpdateHeading">
            <Translate contentKey="repsutApp.ingredient.home.createOrEditLabel">Create or edit a Ingredient</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('repsutApp.ingredient.name')}
                id="ingredient-name"
                name="name"
                data-cy="name"
                type="text"
