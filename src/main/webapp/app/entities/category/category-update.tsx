...
export const CategoryUpdate = () => {
  ...
  const saveEntity = values => {
    ...
    const entity = {
      ...categoryEntity,
      ...values,
      recipes: mapIdList(values.recipes),
    };
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...categoryEntity,
          recipes: categoryEntity?.recipes?.map(e => e.id.toString()),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="repsutApp.category.home.createOrEditLabel" data-cy="CategoryCreateUpdateHeading">
            <Translate contentKey="repsutApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('repsutApp.category.name')}
                id="category-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('repsutApp.category.recipe')}
                id="category-recipe"
                data-cy="recipe"
                type="select"
                multiple
